...
namespace ActivityCenter.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult ActivityDetails(int ActividadID)
        {
            ...
            Actividad helpme = _context.Actividades.Include(a => a.ActiveUser).ThenInclude(ActiveUser => ActiveUser.User).Include(b => b.User).FirstOrDefault(w => w.ActividadID == ActividadID);
            ...
            return View("ActivityDetails", helpme);
