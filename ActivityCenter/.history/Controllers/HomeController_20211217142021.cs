...
namespace ActivityCenter.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult ActivityDetails(int ActividadID)
        {
            ...
            Actividad Activity = _context.Actividades.Include(a => a.ActiveUser).ThenInclude(ActiveUser => ActiveUser.User).Include(b => b.User).FirstOrDefault(w => w.ActivityID == ActivityId);
