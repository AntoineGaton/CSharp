...
namespace ActivityCenter.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult ActivityDetails(int ActividadID)
        {
            ...
            Actividad Activity = _context.ActivityName.Include(a => a.ActiveUser).ThenInclude(ActiveUser => ActiveUser.User).Include(b => b.User).FirstOrDefault(w => w.ActivityId == ActivityId);
        ...
        [HttpPost("/Activity/{ActividadID}/Join")]
        public IActionResult Join(int ActividadID)
        {
            ...
            ActivityUser ActiveUser = _context.ActiveUsers.FirstOrDefault(r => r.UserID == (int)uid && r.ActividadID == ActividadID);
