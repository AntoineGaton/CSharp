...
namespace ActivityCenter.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult ActivityDetails(int ActividadID)
        {
            ...
            Actividad Activity = _context.Activity.Include(a => a.ActiveUser).ThenInclude(ActiveUser => ActiveUser.User).Include(b => b.User).FirstOrDefault(w => w.ActivityId == ActivityId);
