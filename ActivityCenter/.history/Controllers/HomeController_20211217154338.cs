...
namespace ActivityCenter.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Join(int ActividadID)
        {
            ...
            ActivityUser userJoin = new ActivityUser();
            userJoin.UserID = (int)HttpContext.Session.GetInt32("UserID");
            userJoin.ActividadID = ActividadID;
            _context.Add(userJoin);
            _context.SaveChanges();
            return RedirectToAction("AllActividades");
        }

        [HttpPost("Delete/{ActividadID}/Delete")]
        public IActionResult Delete(int ActividadID)
        {
            Actividad Activity = _context.Actividad.FirstOrDefault(w => w.ActividadID == ActividadID);
