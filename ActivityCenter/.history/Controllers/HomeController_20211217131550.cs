...
namespace ActivityCenter.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult AllActividades()
        {
            ...
            List<Actividad> allActvities = _context.Activity.ToList();
            ...
            List<Actividad> newActivities = _context.Activity.OrderBy(date => date.ActivityDate).Include(c => c.ActiveUser).ThenInclude(user => user.User).ToList();
